...
INSERT INTO befiz(azon,datum,osszeg)
VALUES (1001, '2016-01-11 16:25:03', 60000),
...
CREATE TABLE ugyfel(
  azon int(10) unsigned NOT NULL primary key,
...
INSERT INTO ugyfel(azon,nev,szulev,irszam,orsz) 
VALUES 
