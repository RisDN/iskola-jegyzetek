...
INSERT INTO `orszagok` VALUES ('SPANYOLORSZÁG', 'MADRID', 'Dél-Európa:Ibériai-félsziget', 504782.00, 'alkotmányos monarchia', 42700, 5100, 'E', 'SPANYOLORSZAG   ESPANOLA SPAIN', 'MADRID', 'euró', 'EUR', '100 eurocent', 34, 21110, 1);
...
INSERT INTO `orszagok` VALUES ('FRANCIAORSZÁG', 'PÁRIZS', 'Nyugat-Európa', 547026.00, 'köztársaság', 60100, 11300, 'F', 'FRANCIAORSZAG FRANCE FRANCAISE', 'PARIS (PARIZS)', 'euró', 'EUR', '100 eurocent', 33, 27520, 1);
INSERT INTO `orszagok` VALUES ('NAGY-BRITANNIA', 'LONDON', 'Európa:Britt-szigetek', 244046.00, 'alkotmányos monarchia', 59200, 7200, 'GB', 'NAGY-BRITANNIANGLIASKOCIAWALES', 'LONDON', 'font', 'GBP', '100 penny', 44, 29070, 1);
INSERT INTO `orszagok` VALUES ('NORVÉGIA', 'OSLO', 'Észak-Európa:Skandináv-félsziget', 324219.00, 'alkotmányos monarchia', 4600, 800, 'N', 'NORVEGIA                NORWAY', 'OSLO', 'norvég korona', 'NOK', '100 öre', 47, 49090, 1);
...
INSERT INTO `orszagok` VALUES ('FINNORSZÁG', 'HELSINKI', 'Észak-Európa', 338107.00, 'köztársaság', 5200, 1100, 'SF', 'FINNORSZAG             FINLAND', 'HELSINKI', 'euró', 'EUR', '100 eurocent', 358, 30360, 1);
INSERT INTO `orszagok` VALUES ('NÉMETORSZÁG', 'BERLIN', 'Nyugat-Európa', 357042.00, 'szövetségi köztársaság', 82400, 5900, 'D', 'NEMETORSZAG DEUTSCHLANDGERMANY', 'BERLIN', 'euró', 'EUR', '100 eurocent', 49, 28260, 1);
INSERT INTO `orszagok` VALUES ('SVÁJC', 'BERN', 'Közép-Európa:Alpok', 41293.00, 'szövetségi köztársaság', 7260, 100, 'CH', 'SVAJC      SWITZERLAND SCHWEIZ', 'BERN', 'svájci frank', 'CHF', '100 rappen', 41, 42700, 1);
INSERT INTO `orszagok` VALUES ('AUSZTRIA', 'BÉCS', 'Közép-Európa:Alpok', 83858.00, 'szövetségi köztársaság', 8130, 1600, 'A', 'AUSZTRIA    OSTERREICH AUSTRIA', 'WIEN (BECS)', 'euró', 'EUR', '100 eurocent', 43, 30180, 1);
INSERT INTO `orszagok` VALUES ('OLASZORSZÁG', 'RÓMA', 'Dél-Európa:Appennini-félsziget', 301252.00, 'köztársaság', 57400, 3600, 'I', 'OLASZORSZAG       ITALIA ITALY', 'ROMA', 'euró', 'EUR', '100 eurocent', 39, 24390, 1);
INSERT INTO `orszagok` VALUES ('MAGYARORSZÁG', 'BUDAPEST', 'Közép-Európa:Kárpát-medence', 93036.00, 'köztársaság', 10100, 2600, 'H', 'MAGYARORSZAG    HUNGARY UNGARN', 'BUDAPEST', 'forint', 'HUF', '100 fillér', 36, 11200, 1);
INSERT INTO `orszagok` VALUES ('SZERBIA', 'BELGRÁD', 'Dél-Európa:Balkán-félsziget', 88361.00, 'szövetségi köztársaság', 9400, 1700, 'SRB', 'JUGOSZLAVIA SZERBIA YUGOSLAVIA', 'BEOGRAD (BELGRAD)', 'dinár', 'CSD', '100 para', 381, 3200, 1);
...
INSERT INTO `orszagok` VALUES ('SZLOVÁKIA', 'POZSONY', 'Közép-Európa:Kárpátok', 49036.00, 'köztársaság', 5400, 500, 'SK', 'SZLOVAKIA  SLOVAKIA  SLOVENSKO', 'BRATISLAVA  POZSONY', 'szlovák korona', 'SKK', '100 heller', 421, 5810, 1);
INSERT INTO `orszagok` VALUES ('CSEHORSZÁG', 'PRÁGA', 'Közép-Európa', 78864.00, 'köztársaság', 10300, 1300, 'CZ', 'CSEHORSZAG        CSEHSZLOVAKIA', 'PRAHA (PRAGA)', 'cseh korona', 'CZK', '100 haler', 42, 7990, 1);
INSERT INTO `orszagok` VALUES ('LENGYELORSZÁG', 'VARSÓ', 'Közép-Európa', 312677.00, 'köztársaság', 38600, 2200, 'PL', 'LENGYELORSZAG           POLAND', 'WARSZAWA (VARSO)', 'zloty', 'PLZ', '100 grosz', 48, 5370, 1);
INSERT INTO `orszagok` VALUES ('OROSZORSZÁG', 'MOSZKVA', 'Eurázsia', 17075400.00, 'szövetségi köztársaság', 146000, 12000, 'RUS', 'OROSZORSZAG SZOVJETUNIO FAK SZU', 'MOSZKVA', 'rubel', 'RUR', '100 kopejka', 7, 2910, 1);
INSERT INTO `orszagok` VALUES ('GÖRÖGORSZÁG', 'ATHÉN', 'Dél-Európa:Balkán-félsziget', 131944.00, 'köztársaság', 11000, 3300, 'GR', 'GOROGORSZAG GRIECHENLAND GREECE', 'ATHINE ATHENAI', 'euró', 'EUR', '100 eurocent', 30, 15060, 1);
INSERT INTO `orszagok` VALUES ('TÖRÖKORSZÁG', 'ANKARA', 'Eurázsia', 780576.00, 'köztársaság', 71300, 3600, 'TR', 'TOROKORSZAG             TURKEY', 'ANKARA', 'lira', 'TRL', '100 kurus', 90, 3110, 1);
INSERT INTO `orszagok` VALUES ('DÁNIA', 'KOPPENHÁGA', 'Nyugat-Európa:Jylland', 43075.00, 'alkotmányos monarchia', 5300, 1100, 'DK', 'DANIA                  DENMARK', 'KOPPENHAGA', 'dán korona', 'DKK', '100 öre', 45, 38120, 1);
INSERT INTO `orszagok` VALUES ('IZLAND', 'REYKJAVIK', 'Európa:Atlanti-óceán (szigetország)', 102829.00, 'köztársaság', 277, 100, 'IS', 'IZLAND          ISLAND ICELAND', 'REYKJAVIK', 'izlandi korona', 'ISK', '100 aurar', 354, 35780, 1);
...
INSERT INTO `orszagok` VALUES ('BELGIUM', 'BRÜSSZEL', 'Nyugat-Európa', 30519.00, 'alkotmányos monarchia', 10300, 1700, 'B', 'BELGIUM', 'BRUXELLES  BRUSSZEL', 'euró', 'EUR', '100 eurocent', 32, 28800, 1);
INSERT INTO `orszagok` VALUES ('HOLLANDIA', 'AMSZTERDAM', 'Nyugat-Európa', 41548.00, 'alkotmányos monarchia', 16100, 700, 'NL', 'HOLLANDIANIEDERLANDENETHERLAND', 'AMSZTERDAM - HAGA', 'euró', 'EUR', '100 eurocent', 31, 30800, 1);
INSERT INTO `orszagok` VALUES ('LUXEMBURG', 'LUXEMBOURG', 'Nyugat-Európa', 2586.40, 'nagyhercegség', 438, 90, 'L', 'LUXEMBURG', 'LUXEMBOURGLUXEMBURG', 'euro', 'EUR', '100 eurocent', 352, 52510, 1);
...
INSERT INTO `orszagok` VALUES ('CIPRUS', 'NICOSIA', 'Európa:Földközi-tenger (szigetország)', 9251.00, 'köztársaság', 758, 200, 'CY', 'CIPRUS                  CYPRUS', 'NICOSIA', 'ciprusi font', 'CYP', '100 cent', 357, 19010, 1);
INSERT INTO `orszagok` VALUES ('ÍRORSZÁG', 'DUBLIN', 'Európa:Britt-szigetek', 70283.00, 'köztársaság', 3800, 1000, 'IRL', 'IRORSZAG               IRELAND', 'DUBLIN', 'euró', 'EUR', '100 erocent', 353, 38430, 1);
INSERT INTO `orszagok` VALUES ('EGYIPTOM', 'KAIRÓ', 'Észak-Afrika', 1001449.00, 'elnöki köztársaság', 71900, 15900, 'ET', 'EGYIPTOM', 'AL QAHIRAH (KAIRO)', 'egyiptomi font', 'EGP', '100 piaszter', 20, 1300, 1);
INSERT INTO `orszagok` VALUES ('MAROKKÓ', 'RABAT', 'Észak-Afrika:Atlasz', 446550.00, 'alkotmányos monarchia', 30500, 1600, 'MA', 'MAROKKO         NYUGAT-SZAHARA', 'RABAT', 'marokkói dirham', 'MAD', '100 cent', 212, 1499, 1);
...
INSERT INTO `orszagok` VALUES ('KANADA', 'OTTAWA', 'Észak-Amerika', 9976139.00, 'szövetségi állam', 31700, 1100, 'CDN', 'KANADA                  CANADA', 'OTTAWA', 'kanadai dollár', 'CAD', '100 cent', 1, 25650, 1);
INSERT INTO `orszagok` VALUES ('MEXIKÓ', 'MEXIKÓVÁROS', 'Közép-Amerika', 1972547.00, 'szövetségi köztársaság', 103400, 21200, 'MEX', 'MEXIKO                  MEXICO', 'MEXIKOVAROS', 'mexikói peso', 'MXP', '100 centavo', 52, 5930, 1);
INSERT INTO `orszagok` VALUES ('KUBA', 'HAVANNA', 'Közép-Amerika (szigetország)', 110922.00, 'köztársaság', 11300, 2700, 'C', 'KUBA                      CUBA', 'LA HABANA (HAVANNA)', 'kubai peso', 'CUP', '100 centavo', 53, 1700, 1);
...
INSERT INTO `orszagok` VALUES ('IZRAEL', 'TEL-AVIV', 'Ázsia:Közel-Kelet', 20770.00, 'parlamentáris köztársaság', 6400, 700, 'IL', 'IZRAEL', 'TEL AVIV-YAFO JAFFA', 'sékel', 'ISL', '100 új agora', 972, 15420, 1);
...
INSERT INTO `orszagok` VALUES ('AUSZTRÁLIA', 'CANBERRA', 'Ausztrália', 7686420.00, 'államszövetség', 19700, 300, 'AUS', 'AUSZTRALIA           AUSTRALIA', 'CANBERRA', 'dollár', 'AUD', '100 cent', 61, 30060, 1);
...
INSERT INTO `orszagok` VALUES ('IRAK', 'BAGDAD', 'Ázsia:Közel-Kelet', 438466.00, 'elnöki köztársaság', 25100, 5800, 'IRQ', 'IRAK                      IRAQ', 'BAGHDAD (BAGDAD)', 'iraki dinár', 'IQD', '1000 fil', 964, 2100, 1);
...
INSERT INTO `orszagok` VALUES ('SZÍRIA', 'DAMASZKUSZ', 'Ázsia:Közel-Kelet', 185180.00, 'elnöki köztársaság', 17800, 1900, 'SYR', 'SZIRIA                   SYRIA', 'DIMASHO  DAMASZKUSZ', 'sziriai font', 'SYP', '100 piaszter', 963, 1330, 2);
