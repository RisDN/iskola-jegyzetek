...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2025. Feb 21. 10:08
...
--
ALTER TABLE `jaratok`
  MODIFY `jaratok_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT a táblához `megallo`
--
ALTER TABLE `megallo`
  MODIFY `megallo_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=97;

--
-- AUTO_INCREMENT a táblához `utvonal`
--
ALTER TABLE `utvonal`
  MODIFY `utvonal_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=370;
...
--
ALTER TABLE `utvonal`
  ADD CONSTRAINT `utvonal_ibfk_1` FOREIGN KEY (`jarat_id`) REFERENCES `jaratok` (`jaratok_id`),
  ADD CONSTRAINT `utvonal_ibfk_2` FOREIGN KEY (`megallo_id`) REFERENCES `megallo` (`megallo_id`);
COMMIT;
